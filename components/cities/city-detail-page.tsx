...
import { CATEGORY_OPTIONS, getCategoryBySlug, getCategoryIcon } from "@/components/categories/category-taxonomy"
import type { CitySlug } from "@/components/cities/city-taxonomy"
import { CITY_METADATA, getCityBySlug } from "@/components/cities/city-taxonomy"
import { EXPLORE_PRICE_OPTIONS, EXPLORE_RESULTS, EXPLORE_SORT_OPTIONS } from "@/components/explore/explore-data"
...
import { ClosedBadge, MithoBadge, OpenNowBadge } from "@/components/ui/mitho-badge"
...
export function CityDetailPage({ slug }: CityDetailPageProps) {
  ...
  React.useEffect(() => {
    setCurrentPage(1)
  }, [filters.q, filters.category, filters.sort, filters.price])
  ...
  const hasActiveFilters =
    Boolean(filters.q) || filters.category !== "all" || filters.sort !== "recommended" || filters.price !== "any"
                ...
                <Sheet>
                  ...
                  <SheetContent side="bottom" className="rounded-t-[1.75rem] border-brand-deep-green/10 bg-[#fffdf8]">
                    <SheetHeader>
                      ...
                      <SheetDescription>Adjust category, price, and ranking without leaving this city guide.</SheetDescription>
                    </SheetHeader>
