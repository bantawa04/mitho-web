      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-2">
            <BrandLogo kind="icon" tone="green" className="h-9 w-auto sm:hidden" alt="Mitho Cha! logo" />
            <BrandLogo kind="wordmark" tone="green" className="hidden h-10 w-auto sm:block" alt="Mitho Cha! wordmark" />
          </Link>
