...
export function AdminCuisinesPage() {
  ...
  }, [currentPage, filteredCuisines, pageSize])
          ...
          <div className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <p className="text-sm font-semibold text-foreground">{selectedCuisine.name}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-border bg-muted px-4 py-4">
                ...
                <p className="mt-2 text-sm font-semibold text-foreground">{selectedCuisine.listingsCount ?? 0}</p>
              </div>
              <div className="rounded-xl border border-border bg-muted px-4 py-4">
                <p className="text-xs font-medium text-muted-foreground">Last updated</p>
                <p className="mt-2 text-sm font-semibold text-foreground">{formatAdminDateTime(selectedCuisine.updatedAt)}</p>
              </div>
            </div>
          </div>
        ) : null}
