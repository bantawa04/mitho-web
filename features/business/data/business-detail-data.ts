...
export const emptyBusinessPageData: BusinessPageData = {
  ...
  visitInfo: {
    ...
    website: undefined,
    email: undefined,
    coordinates: { lat: 27.6736, lng: 85.3247 },
    mapZoom: 15,
    hours: [
    ...
    cuisines: ["Nepali"],
    amenities: ["dineIn", "takeaway"],
    mapDescription: "Tucked just off the Patan courtyard lanes and easy to reach on foot.",
    mapLinkText: undefined,
    goodToKnow:
      "Looks like a calm local option for lunch or a casual evening meal, but the page still needs firsthand local detail.",
  },
  galleryItems: [],
  galleryEmptyMessage: "No one has added photos yet. The first visit photos can help people quickly understand what this place feels like.",
  menuItems: [],
  menuEmptyMessage: "No dish notes yet. Once locals start reviewing, the items people mention most can appear here.",
  menuLink: undefined,
  ratingsData: null,
  reviews: [],
  reviewsEmptyMessage: "No one has reviewed this place on Mitho yet. If you visit, your review can become the first useful signal for everyone else.",
  addReviewPrompt: "Help start this page with the first local review.",
}
