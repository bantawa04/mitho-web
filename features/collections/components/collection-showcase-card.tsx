...
export function CollectionShowcaseCard({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group relative block aspect-[4/5] overflow-hidden rounded-[1.35rem] bg-[#f7f1e7] shadow-[0_8px_24px_rgba(10,70,53,0.10)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(10,70,53,0.14)]",
        className,
      )}
    >
      {coverImage ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-[#f6ede0] text-brand-deep-green/38">
